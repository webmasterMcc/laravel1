                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4"> 
                            <x-nav-link href="/laravel1/public/"        :active="request()->is('/')" >Home</x-nav-link>
                            <x-nav-link href="/laravel1/public/about"   :active="request()->is('about')">About</x-nav-link>
                            <x-nav-link href="/laravel1/public/contact" :active="request()->is('contact')">Contact</x-nav-link>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
